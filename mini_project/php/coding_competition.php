<?php
    ...
    $sql_query = "SELECT * from `coding_competition` WHERE `college_id` = '$college_id';";
    $result = mysqli_query($con, $sql_query);
    $row = mysqli_fetch_row($result);
    ...
    $sql_query = "INSERT INTO `coding_competition` (`name`, `college_id`, `year`, `section`, `branch`) VALUES ('$name', '$college_id', '$year', '$section', '$branch');";
    $result = mysqli_query($con, $sql_query);
    if($result) {
        echo "Success";
    }
